...
public class Pub {
	...
	public Pub(int id, String adresse, String type, float price, int intSurface, int extSurface, int rooms) {
		super();
		this.id = id;
	...
	public Pub(String adresse, String type, float price, int intSurface, int extSurface, int rooms,
			Long numberBathrooms, Long numberGarages) {
		super();
		this.adresse = adresse;
		this.type = type;
		this.price = price;
